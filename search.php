...
<?php  
 ...
 $query = "SELECT * FROM book_details where name Like '%$search%' or auther_name Like '%$search%' ";  
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="addbook.php">Add Books<span class="sr-only">(current)</span></a></li>
      ...
      <form class="navbar-form navbar-left">
        <div class="form-group" method="get" action="search.php">
...
<br/> 
           ...
           <div class="container" style="width:100%;">  
                <h3 align="center">search details of books</h3>  
                <br />  
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td> <?php echo "<a class='btn btn-danger' href=\"delete.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> 
                        " ?></td> 
                          </tr>  
                          <?php  
                          }  
